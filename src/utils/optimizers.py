...
def get_one_cycle_scheduler(optimizer: torch.optim.Optimizer,
...
def get_scheduler(scheduler_name: str, optimizer: torch.optim.Optimizer,
                  scheduler_params: dict):
    """ Function to get the required schedule learning_rate """
    scheduler_mapping = {'OneCycle': get_one_cycle_scheduler}

    return scheduler_mapping[scheduler_name](optimizer=optimizer,
